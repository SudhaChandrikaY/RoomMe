...
export const mockRoommates: RoommateProfile[] = [
  {
    ...
    bio: 'Graduate student who loves reading and yoga. Looking for a peaceful living environment.',
  ...
  },
  {
    ...
    bio: 'Medical student with a focus on wellness. Prefers a calm, organized living space.',
    interests: ['Medicine', 'Meditation', 'Hiking', 'Healthy Cooking'],
    contactInfo: {
      email: 'djsaiyo@gmail.com',
